            ...
            <form action="{{ route('empresas.update', $empresa->id) }}" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="razaoSocial" id="razaoSocial" placeholder="Razão Social"
                        autocomplete="off" value="{{old('razaoSocial')?? $empresa->razaoSocial}}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="nomeFantasia" id="nomeFantasia"
                        placeholder="Nome Fantasia" autocomplete="off" value="{{old('nomeFantasia')?? $empresa->nomeFantasia}}">
                ...
                <div class="text-right">
                    ...
                    <button class="btn btn-success " type="submit">Salvar Edicão</button>
                </div>
            </form>
        </div>
